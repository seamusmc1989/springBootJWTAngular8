package com.angularBootRef.springBootPortfolio.configuration;

import com.angularBootRef.springBootPortfolio.domain.Constants;
...
public class JwtTokenUtil implements Serializable {
    ...
    private String doGenerateToken(String subject, List<UserRole> userRoles) {

        Claims claims = Jwts.claims().setSubject(subject);
        //claims.put("scopes", Arrays.asList(new SimpleGrantedAuthority("ROLE_ADMIN")));
        claims.put("scopes", getAuthorities(userRoles));


        return Jwts.builder()
                .setClaims(claims)
                .setIssuer("http://seamusmccarthy.ie")
